...
当前第一个未完成项：GP.2 清零所有用户可见 `unimplemented` stub
...
| Wave | **G0 ✅ · G1 ✅ · G2 ✅ · G3 ✅ · G4 ✅ · G5 ✅ · T5.1–T5.8 ✅ · GP.1 ✅**；下一 **GP.2** |
...
| **GP.2–GP.6** | stub、全测/H、README、PERFECT 文档与停止 loop | |
...
| 2026-07-15 | GP.1 | （提交后回填） | 覆盖率严格门禁实跑 114/114（100%）；command 46/46、domain 28/28、log 20/20、settings 13/13、overlay 7/7，partial/missing 均为 0；覆盖率脚本 2 项单测通过；P-INV/P-COV/H-GP ✅；下一刀 GP.2 |
