...
| 2026-07-13 | T2.12 | （提交后回填） | Repo Browser 远端 mkdir/delete/copy/move/rename；高危二次确认；远端 owner/comment/created 锁列；全量 671 绿，含真实 SVN 写操作/锁信息集成测 | #10、D24 ✅；§4.5 远端写/锁列 ✅ | 下一 T2.13 |
