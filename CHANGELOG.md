...
- Summary: RC 合入 main：PR #2 已合并
- Affected: docs/acceptance/release-closeout-2026-07-22.md, docs/acceptance/release-notes-rc-2026-07-22.md, docs/superpowers/specs/2026-07-22-release-closeout-design.md, docs/superpowers/plans/2026-07-22-release-closeout.md, README.md, CHANGELOG.md
- Impact: 将 `feat/tortoise-parity-perfect-loop` 以 merge commit `89dc6a5` 合入 `main`（https://github.com/yclenove/mac-svn-desktop/pull/2）；回填合入证据；不改 inventory/H-tortoise；公证 residual 仍在
